    ...
    return (
      <Dialog onClose={handleClose} open={open} PaperComponent={PaperComponent}>
        <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
          <h4 className="mb-20">{t("EQARound.ChoosePlaning")}</h4>
        </DialogTitle>
        <DialogContent>
          <Grid item xs={12}>
            ...
            <TextField className="mb-16 mr-10" placeholder={t('EQARound.EnterSearch')} type="text" value={keyword} onChange={this.handleChange} />
            <Button className="mb-16 mr-16" variant="contained" color="primary" onClick={() => this.search(keyword)}>{t('Search')}</Button>
          </Grid>
          <Grid item xs={12}>
