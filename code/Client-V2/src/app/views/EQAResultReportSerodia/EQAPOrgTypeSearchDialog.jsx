...
import { getByPage, deleteItem, getListTechnicians } from "../EQAHealthOrgType/EQAHealthOrgTypeService";
    ...
    return (
      <Dialog onClose={handleClose} open={open} PaperComponent={PaperComponent}>
        <DialogTitle style={{ cursor: 'move' }} id="draggable-dialog-title">
          <span className="mb-20">{t("EQAHealthOrg.ChoosePlaning")}</span>
        ...
        <DialogContent>
          <Grid item xs={12}>
            ...
            <Button className="mb-16 mr-36  align-bottom" variant="contained" color="secondary" onClick={() => handleClose()}>{t('Cancel')}</Button>
            {/* <TextField id="keyword"  name="keyword"  value={this.state.keyword} onChange={this.handleTextChange}></TextField> */}
            <TextValidator className="mb-16 mr-10" label={t('EnterSearch')} type="text" value={keyword} onChange={this.handleChange} />
            <Button className="mb-16 mr-16 align-bottom" variant="contained" color="primary" onClick={() => this.search(keyword)}>{t('Search')}</Button>
          </Grid>
          <Grid item xs={12}>
