...
import EQAResultReportElisaFilePopup from "./EQAResultReportFastTestFilePopup";
...
class EQAResultReportFastTestFileAttachment extends React.Component {
  constructor(props) {
    super(props);
  }
  state = {
...
export default EQAResultReportFastTestFileAttachment;
