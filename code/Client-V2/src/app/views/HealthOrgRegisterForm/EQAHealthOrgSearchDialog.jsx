...
class EQAHealthOrgSearchDialog extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <Dialog onClose={handleClose} open={open} PaperComponent={PaperComponent}>
        ...
        <DialogContent dividers>
          <Grid item xs={12}>
            <Button
              className="mb-16 mr-16 align-bottom" variant="contained" color="primary" onClick={() => handleSelect(this.state.selectedItem)}>
              {t('Select')}
            </Button>
            ...
            <TextValidator label={t('EnterSearch')} className="mb-16 mr-10" value={this.state.value} onChange={this.handleChange} />
...
export default EQAHealthOrgSearchDialog;