...
class EQASampleFilePopup extends Component {
  state = {
    name: "",
    code: "",
    description: "",
  ...
  fileUpload(file) {
    const url = ConstantList.API_ENPOINT + "/api/file/eQASample/eQASampleDocument/uploadattachment";
...
export default EQASampleFilePopup;
