import {
  ...
  import {downloadDocument} from "./EQASampleListService";
  ...
  import EQASampleFilePopup from "./EQASampleFilePopup";
  ...
  class EQASampleFileAttachment extends React.Component {
    constructor(props) {
      super(props);
    }
    state = {
  ...
  export default EQASampleFileAttachment;
