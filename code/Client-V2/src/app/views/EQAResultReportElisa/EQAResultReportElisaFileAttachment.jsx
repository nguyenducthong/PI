...
import EQAResultReportElisaFilePopup from "./EQAResultReportElisaFilePopup";
      ...
      { title: t("file.name"), field: "file.name", align: "left", width: "250px" },
      {
        ...
        render: rowData =>
          <div className="none_wrap">
            ...
            {!this.props.isRoleAdmin && (<LightTooltip title={t('general.deleteIcon')} placement="top" enterDelay={300} leaveDelay={200}>
