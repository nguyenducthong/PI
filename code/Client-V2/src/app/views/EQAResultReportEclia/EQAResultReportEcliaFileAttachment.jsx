...
import EQAResultReportEcliaFilePopup from "./EQAResultReportEcliaFilePopup";
...
class EQAResultReportEcliaFileAttachment extends React.Component {
  constructor(props) {
    super(props);
  }
  state = {
...
export default EQAResultReportEcliaFileAttachment;
