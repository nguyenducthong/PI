...
class ReferenceDocumentFilePopup extends Component {
  state = {
    name: "",
    code: "",
    description: "",
  ...
  fileUpload(file) {
    const url = ConstantList.API_ENPOINT + "/api/file/referenceDocument/uploadattachment";
...
export default ReferenceDocumentFilePopup;
