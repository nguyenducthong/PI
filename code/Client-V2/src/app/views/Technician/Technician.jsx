...
import { deleteItem, saveItem, getItemById, searchByPage } from "./TechnicianService";
import TechnicianEditorDialog from "./TechnicianEditorDialog";
...
class Technician extends React.Component {
  ...
  render() {
    ...
    let columns = [
      ...
      {
        title: t("EQAHealthOrg.title"), field: "healthOrg.name", align: "left", width: "150",
        headerStyle: {
          minWidth: "150px",
          paddingLeft: "10px",
          paddingRight: "0px",
      ...
      {
        title: t("Qualification.title"), field: "qualification.name", width: "150",
    ...
    return (
      <div className={homepage == undefined ? "m-sm-30" : ""}>
        { homepage == undefined && (<Helmet>
          <title>{t("Technician.title")} | {t("web_site")}</title>
        </Helmet>)}
        {homepage == undefined && (<div className="mb-sm-30">
          <Breadcrumb routeSegments={[{ name: t("category"), path: "/directory/apartment" }, { name: t("Technician.title") }]} />
        </div>)}
        ...
        <Grid item xs={12}>
          <div>
            {shouldOpenEditorDialog && (
              <TechnicianEditorDialog t={t} i18n={i18n}
