(function () {
    ...
    angular.module('EQA.Results').controller('ResultSetController', ResultSetController);

    ResultSetController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function ResultSetController ($rootScope, $scope, $http, $timeout, settings, utils, modal, blockUI, toastr, service) {
