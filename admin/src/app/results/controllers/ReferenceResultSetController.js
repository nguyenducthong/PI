(function () {
    ...
    angular.module('EQA.Results').controller('ReferenceResultSetController', ReferenceResultSetController);

    ReferenceResultSetController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function ReferenceResultSetController ($rootScope, $scope, $http, $timeout, settings, utils, modal, blockUI, toastr, service) {
