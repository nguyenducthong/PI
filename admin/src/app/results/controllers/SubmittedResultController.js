(function () {
    ...
    angular.module('EQA.Results').controller('SubmittedResultController', SubmittedResultController);

    SubmittedResultController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function SubmittedResultController ($rootScope, $scope, $http, $timeout, settings, utils, modal, blockUI, toastr, service) {
        ...
        vm.getSubmittedResults = function () {
            service.getSubmittedResults().then(function(data) {
        ...
        vm.bsTableControl = {
            options: {
                ...
                columns: service.getTableDefinition4SubmittedResults(),
