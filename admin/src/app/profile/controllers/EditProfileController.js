(function () {
    ...
    angular.module('EQA.Profile').controller('EditProfileController', EditProfileController);
    ...
    function EditProfileController ($rootScope, $scope, $http, $timeout, settings, $state, utils) {
        ...
        vm.cancel = function () {
            $state.go('application.view_profile');
        };
    }
