(function () {
    ...
    angular.module('EQA.Mixture').controller('SerumBankController', SerumBankController);

    SerumBankController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function SerumBankController ($rootScope, $scope, $http, $timeout, settings, utils, service, modal) {
        ...
        {
            options: {
                dropdownSelector: '#dropdown_starttime',
                startView: 'day',
                minView: 'day'
            }
        };
        ...
        {
            options: {
                dropdownSelector: '#dropdown_endtime',
                startView: 'day',
                minView: 'day'
            }
        };
