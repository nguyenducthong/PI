(function () {
    ...
    angular.module('EQA.Mixture').controller('LabelPrintingController', LabelPrintingController);

    LabelPrintingController.$inject = [
        '$rootScope',
        '$scope',
        '$http',
        '$timeout',
    ...
    function LabelPrintingController ($rootScope, $scope, $http, $timeout, settings, utils, service, modal) {
        ...
        vm.target = 1;
        vm.targetNames = [
            'IN NHÃN CHO ỐNG TUBE CHỨA MẪU GỬI ĐI', 'IN NHÃN CHO NGÂN HÀNG HUYẾT THANH'
        ];

        vm.changeTarget = function (tab) {
            vm.target = tab;
        };
