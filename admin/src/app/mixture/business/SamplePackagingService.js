(function () {
    ...
    angular.module('EQA.Mixture').service('SamplePackagingService', SamplePackagingService);

    SamplePackagingService.$inject = [
        '$http',
        '$q',
        '$filter',
        'settings',
    ...
    function SamplePackagingService($http, $q, $filter, settings, utils) {
        var self = this;
        ...
        function getTableDefinition() {
            ...
            var _tableOperation = function (value, row, index) {
                return '<a class="green-dark margin-right-20" href="#" data-ng-click="$parent.startPackaging(' + "'" + row.id + "'" + ')"><i class="fa fa-random margin-right-5"></i>Ra tube cho ngân hàng này</a>';
            };
